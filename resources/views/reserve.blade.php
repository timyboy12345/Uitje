                    ...
                    <div class="flex flex-col @if(!$loop->last) mb-8 @endif">
                        @switch($reservationTypeLine->type)
                            ...
                            <input type="text"
                                   ...
                                   name="{{ $reservationTypeLine->id }}"
                                   class="transition duration-100 focus:ring-secondary focus:border-secondary rounded border-gray-200 py-1 px-2"
                                   value="{{ old($reservationTypeLine->id) }}">
                            <p class="text-xs text-gray-400 mt-1">{{ $reservationTypeLine->description }}</p>
                            @break
                            @case('text')
                            <label for="{{ $reservationTypeLine->id }}"
                                   class="mb-1">{{ $reservationTypeLine->label }}</label>
                            <textarea id="{{ $reservationTypeLine->id }}" name="{{ $reservationTypeLine->id }}"
                                      class="transition duration-100 focus:ring-secondary focus:border-secondary rounded border-gray-200 py-1 px-2">{{ old($reservationTypeLine->id) }}</textarea>
                            <p class="text-xs text-gray-400 mt-1">{{ $reservationTypeLine->description }}</p>
                            @break
                            @case('number')
                            <label for="{{ $reservationTypeLine->id }}"
                            ...
                            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-2">
                                <div class="flex flex-col lg:col-span-2">
                                    ...
                                    <input type="text"
                                           ...
                                           name="{{ $reservationTypeLine->id }}postalcode"
                                           class="transition duration-100 focus:ring-secondary focus:border-secondary rounded border-gray-200 py-1 px-2"
                                           value="{{ old("{$reservationTypeLine->id}postalcode") }}"
                                    >
                                    <p class="text-xs text-gray-400 mt-1">{{ $reservationTypeLine->description }}</p>
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input type="text"
                                           ...
                                           name="{{ $reservationTypeLine->id }}number"
                                           class="transition duration-100 focus:ring-secondary focus:border-secondary rounded border-gray-200 py-1 px-2"
                                           value="{{ old("{$reservationTypeLine->id}number") }}"
                                    >
                                    <p class="text-xs text-gray-400 mt-1">{{ $reservationTypeLine->description }}</p>
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input type="text"
                                           ...
                                           name="{{ $reservationTypeLine->id }}streetname"
                                           class="transition duration-100 focus:ring-secondary focus:border-secondary rounded border-gray-200 py-1 px-2"
                                           value="{{ old("{$reservationTypeLine->id}streetname") }}"
                                    >
                                    <p class="text-xs text-gray-400 mt-1">{{ $reservationTypeLine->description }}</p>
                                ...
                                <div class="flex flex-col lg:col-span-2">
                                    ...
                                    <input type="text"
                                           ...
                                           name="{{ $reservationTypeLine->id }}city"
                                           class="transition duration-100 focus:ring-secondary focus:border-secondary rounded border-gray-200 py-1 px-2"
                                           value="{{ old("{$reservationTypeLine->id}city") }}">
                                    <p class="text-xs text-gray-400 mt-1">{{ $reservationTypeLine->description }}</p>
